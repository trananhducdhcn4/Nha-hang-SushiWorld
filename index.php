...
<body>
    ...
    <?php include "template-parts/special-menu.php"; ?>
    <?php include "template-parts/menu.php"; ?>
    <?php include "template-parts/pricing.php"; ?>
    <?php include "template-parts/reservation.php"; ?>
    <?php include "template-parts/about.php"; ?>
    <?php include "template-parts/our_team.php"; ?>
    <?php include "template-parts/gallery.php"; ?>
    <?php include "template-parts/blog.php"; ?>
